...
public interface AlunoRepository extends JpaRepository<Aluno, Long> {
    ...
    List<Aluno> findAllByAnoLetivoIsBetweenOrderByAnoLetivoDescNomeAsc(Integer inicio, Integer fim);

    List<Aluno> findAllByNomeStartingWithIgnoreCaseAndNomeEndingWithIgnoreCase(String nome, String sobrenome);

    @Query("SELECT MAX(a.anoLetivo) FROM Aluno a")
    Integer findMaxAnoLetivo();

    List<Aluno> findFirst3ByAnoLetivoOrderByIdAsc(Integer anoLetivoMaisRecente);
